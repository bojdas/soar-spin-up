...
//new config for drive is in chassis
#define LEFT_MOTORS 13 -12, -11
#define RIGHT_MOTORS -14, 16, 18
#define GEARSET pros::E_MOTOR_GEAR_600 // RPM of chassis motors

// Ticks per inch
#define TPI 45.4728408834    			  // Encoder ticks per inch of forward robot movement
#define MIDDLE_TPI 1          // Ticks per inch for the middle wheel

// Tracking wheel distances
#define TRACK_WIDTH 11.8 		  // The distance between left and right wheels (or tracker wheels)
...
// Movement tuning
#define SLEW_STEP 2         // Smaller number = more slew
...
#define LINEAR_KP 10
#define LINEAR_KI 0.008
#define LINEAR_KD 7
#define TRACKING_KP 50		 // point tracking turning strength
#define ANGULAR_KP 1.1
#define ANGULAR_KI 0.006
#define ANGULAR_KD 4.37
...
#define DEFAULT 8 // Default auton selected
